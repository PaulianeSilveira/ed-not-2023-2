...
"""Comentário - Docstring - serve para documentar funções e classes - aceita vária linhas """
...
def calc_area(base, altura, tipo):
    # resultado = None #undefined no JS - valor não existente
    if tipo == "R": # Retângulo  = atribuição; == comparação
